...
@implementation UIButton (JDLImagePosition)
...
- (void)JDL_imagePositionStyle:(JDLImagePositionStyle)imagePositionStyle spacing:(CGFloat)spacing {
    if (imagePositionStyle == JDLImagePositionStyleLeft) {
    ...
    } else if (imagePositionStyle == JDLImagePositionStyleRight) {
    ...
    } else if (imagePositionStyle == JDLImagePositionStyleTop) {
    ...
    } else if (imagePositionStyle == JDLImagePositionStyleBottom) {
        CGFloat imageW = self.imageView.frame.size.width;
        CGFloat imageH = self.imageView.frame.size.height;
        CGFloat titleIntrinsicContentSizeW = self.titleLabel.intrinsicContentSize.width;
        CGFloat titleIntrinsicContentSizeH = self.titleLabel.intrinsicContentSize.height;
...
-(void)JDL_setBorder:(CGFloat )flout color:(UIColor *)color{
    self.layer.borderColor =color.CGColor;
    self.layer.borderWidth =flout;
}
